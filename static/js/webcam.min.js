...
window.webcam = {
	...
	swf_url: '/static/js/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: '/static/js/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : '/static/js/shutter.mp3';
	},
